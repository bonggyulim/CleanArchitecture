...
class MyPageViewModel @Inject constructor(
    ...
    private val _getLikeVideoList = MutableStateFlow<UiState<List<DomainLikeVideoEntity>>>(UiState.Loading)
    val getLikeVideoList: StateFlow<UiState<List<DomainLikeVideoEntity>>> get() = _getLikeVideoList
