...
class MyPageViewModel @Inject constructor(
    ...
    private val _getLikeVideoList = MutableStateFlow<List<LikeVideoEntity>>(emptyList())
    val getLikeVideoList: StateFlow<List<LikeVideoEntity>> get() = _getLikeVideoList
